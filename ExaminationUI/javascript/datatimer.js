...
document.writeln('<iframe id=endDateLayer frameborder=0 width=220px height=260px style="position: absolute; margin-left:300px; z-index: 9998; display: none"></iframe>');
strFrame = '<style>';
...
strFrame += '         onmouseover="style.color=\'#ff0000\'" onmouseout="style.color=\'#1478eb\'" title="当前日期时间">当前</span>&nbsp;<span style="cursor:hand; width=30px" id=evaAllOK onmouseover="style.color=\'#ff0000\'" onmouseout="style.color=\'#1478eb\'" onclick="parent.closeLayer()" title="关闭日历">关闭&nbsp;</span></td></tr>';
